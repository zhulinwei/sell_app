...
<style>
    ...
    .seller .bulletin .supports .support-item .icon.decrease {
        background-image: -webkit-image-set( url('decrease_4@2x.png') 1x, url('decrease_4@2x.png') 2x,url('decrease_4@3x.png') 3x );                
    }    
    .seller .bulletin .supports .support-item .icon.discount {
        background-image: -webkit-image-set( url('discount_4@2x.png') 1x, url('discount_4@2x.png') 2x,url('discount_4@3x.png') 3x );                        
    }
    .seller .bulletin .supports .support-item .icon.guarantee {
        background-image: -webkit-image-set( url('guarantee_4@2x.png') 1x, url('guarantee_4@2x.png') 2x,url('guarantee_4@3x.png') 3x );                                
    }
    .seller .bulletin .supports .support-item .icon.invoice {
        background-image: -webkit-image-set( url('invoice_4@2x.png') 1x, url('invoice_4@2x.png') 2x,url('invoice_4@3x.png') 3x );                                
    }
    .seller .bulletin .supports .support-item .icon.special {
        background-image: -webkit-image-set( url('special_4@2x.png') 1x, url('special_4@2x.png') 2x,url('special_4@3x.png') 3x );                                
    }    
    ...
    .seller .bulletin .favorite .icon-favorite {
        display: block;
        margin-bottom: 4px;
        line-height: 24px;
        font-size: 24px;
    ...
    .seller .bulletin .favorite .icon-favorite.active {
        color: rgb(240, 20, 20);
    }    
    .seller .bulletin .favorite .text {
        line-height: 10px;
        font-size: 10px;
        color: rgb(77, 85, 93);
    }
